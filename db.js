...
const DATA_DIR = process.env.DATA_DIR || (process.env.VERCEL ? path.join('/tmp', 'gocare-data') : path.join(__dirname, 'data'));
...
function seed() {
  ...
  if (!hasSvc) {
    const S = [
      ['nursing', 'Nursing Services', '🩺', 'Home nursing support, patient assistance and routine care at home.',
       ...
       [], 'assets/nursing-care.jpg', 'nursing.html'],
      ...
      ['pathologist', 'Pathologist Services', '🔬', 'Home sample collection support with safe and hygienic handling.',
       ...
       [], 'assets/pathology-diagnostics.jpg', 'pathologist.html'],
      ['compounder', 'Compounder Services', '💉', 'Injections, IV drip support, wound dressing and medicine management assistance.',
       ...
       [], 'assets/pharmacy-compounding.jpg', 'compounder.html'],
      ['physiotherapy', 'Physiotherapy Services', '🦵', 'At-home physiotherapy support for mobility, strength and recovery.',
       ...
       [], 'assets/physiotherapy-home.jpg', 'physiotherapy.html'],
      ['nurse', 'Nurse Services', '🤝', 'Dedicated nurse support for elderly care and day-to-day patient needs.',
       ...
       [], 'assets/caretaker-services.jpg', 'nurse.html'],
      ['ambulance', 'Ambulance Services', '🚑', 'Emergency assistance and patient transfer support with quick contact.',
       ...
       [], 'assets/ambulance-247.jpg', 'ambulance.html'],
    ];
  ...
  const DEF = {
    ...
    business_hours: '', logo: 'assets/logo.jpg', favicon: 'assets/logo.jpg',
    ...
    hero_secondary_text: 'Call 7759993511', hero_image: 'assets/home-healthcare-solutions.jpg',
    ...
    home_about_image: 'assets/expert-care-doorstep.jpg',
    ...
    about_image: 'assets/nursing-care.jpg',
  ...
  if (!db.prepare('SELECT COUNT(*) c FROM media').get().c) {
    const A = [
      ...
      ['nursing-care.jpg', 'assets/nursing-care.jpg', 'Nursing Services', 'nursing'],
      ['pathology-diagnostics.jpg', 'assets/pathology-diagnostics.jpg', 'Pathologist Services', 'pathologist'],
      ['pharmacy-compounding.jpg', 'assets/pharmacy-compounding.jpg', 'Compounder Services', 'compounder'],
      ['physiotherapy-home.jpg', 'assets/physiotherapy-home.jpg', 'Physiotherapy Services', 'physiotherapy'],
      ['caretaker-services.jpg', 'assets/caretaker-services.jpg', 'Nurse Services', 'nurse'],
      ['ambulance-247.jpg', 'assets/ambulance-247.jpg', 'Ambulance Services', 'ambulance'],
      ['home-healthcare-solutions.jpg', 'assets/home-healthcare-solutions.jpg', 'Home Healthcare Solutions', 'homepage'],
      ['expert-care-doorstep.jpg', 'assets/expert-care-doorstep.jpg', 'Expert Care At Doorstep', 'homepage'],
      ['services-overview.jpg', 'assets/services-overview.jpg', 'All Services Overview', 'homepage,about,services'],
    ];
